...
namespace vc4cl
{
	...
	public:
		...
		virtual void fillPixelData(const std::array<std::size_t, 3>& pixelCoordinates, const std::array<std::size_t, 3>& pixelRegion, void* fillColor) const;

		static bool copyPixelData(const TextureAccessor& source, TextureAccessor& destination, const std::array<std::size_t, 3>& sourceCoordinates, const std::array<std::size_t, 3>& destCoordinates, const std::array<std::size_t, 3>& pixelRegion);
	...
	public:
		...
		//These function are overridden to provide a better performance by copying a scan-line at once and not every single pixel
		void readPixelData(const std::array<std::size_t, 3>& pixelCoordinates, const std::array<std::size_t, 3>& pixelRegion, void* output, std::size_t outputRowPitch, std::size_t outputSlicePitch) const override;
		void writePixelData(const std::array<std::size_t, 3>& pixelCoordinates, const std::array<std::size_t, 3>& pixelRegion, void* source, std::size_t sourceRowPitch, std::size_t sourceSlicePitch) const override;
	};
